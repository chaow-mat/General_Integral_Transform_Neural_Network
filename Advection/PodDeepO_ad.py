...
################################################################
string =  str(ntrain) + '_dpca_' + str(r_g) + '_l' + str(cfg.layers) + '_dw' + str(cfg.d_width) + '_cw' + str(cfg.c_width) + '_lw' + str(cfg.lift_width) + '_layer' + str(cfg.layers) + '_lr_' + str(learning_rate) + '-' + str(step_size) + '-' + str(gamma) + '_noliz' + str(cfg.noliz)
