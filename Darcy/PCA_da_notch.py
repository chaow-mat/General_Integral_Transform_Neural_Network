...
inputs = data['f_bc'].T # [101, 40000]
outputs = data['u_field'].T # [2295, 40000]
...
for ep in range(epochs):
    ...
    if cfg.state == 'eval':
        ...
        savemat('predictions/PCA/PCA_da_median_' + string + '_id' + str(idx_median) + '.mat',
        ...
        savemat('predictions/PCA/PCA_da_max_' + string + '_id' + str(idx_max) + '.mat',
                {'input': input, 'output': output, 'output_true': output_true})
