...
parser.add_argument('--dim_PCA', type=int, default=21)
...
for ep in range(epochs):
    ...
    if cfg.state == 'eval':
        ...
        savemat('predictions/PCA/PCA_sm_median_' + string + '_id' + str(idx_median) + '.mat',
        ...
        savemat('predictions/PCA/PCA_sm_max_' + string + '_id' + str(idx_max) + '.mat',
                {'input': input, 'output': output, 'output_true': output_true})
