...
outputs = data['sol']  # [40000, 101, 101]
...
for ep in range(epochs):
    ...
    if cfg.state == 'eval':
        ...
        savemat('predictions/FNO/FNO_sm_median_' + string + '_id' + str(idx_median) + '.mat',
        ...
        savemat('predictions/FNO/FNO_sm_max_' + string + '_id' + str(idx_max) + '.mat',
                {'input': input, 'output': output, 'output_true': output_true})
