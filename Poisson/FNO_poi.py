...
for ep in range(epochs):
    ...
    if cfg.state=='eval':
        ...
        savemat('predictions/FNO/FNO_poi_median_' + string + '_id' + str(idx_median) +'.mat', {'input':input, 'output': output, 'output_true':output_true})
        # max
        ...
        savemat('predictions/FNO/FNO_poi_max_' + string + '_id' + str(idx_max) + '.mat',
