...
parser.add_argument('--M', type=int, default=5000, help="number of dataset")
parser.add_argument('--lift_width', type=int, default=4096)
...
for ep in range(epochs):
    ...
    if cfg.state == 'eval':
        ...
        savemat('predictions/PodDeepOnet/PodDeepOnet_ns_median_' + string + '_id' + str(idx_median) + '.mat',
        ...
        savemat('predictions/PodDeepOnet/PodDeepOnet_ns_max_' + string + '_id' + str(idx_max) + '.mat',
                {'input': input, 'output': output, 'output_true': output_true})
