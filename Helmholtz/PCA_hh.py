...
for ep in range(epochs):
    ...
    if ep % 10 == 0:
        ...
        print(f"Average Relative Test Error PCA: {ep } {average_relative_error: .6e}")
        if cfg.state=='train':
    ...
    if cfg.state == 'eval':
        ...
        savemat('predictions/PCA/PCA_hh_median_' + string + '_id' + str(idx_median) + '.mat',
        ...
        savemat('predictions/PCA/PCA_hh_max_' + string + '_id' + str(idx_max) + '.mat',
                {'input': input, 'output': output, 'output_true': output_true})
