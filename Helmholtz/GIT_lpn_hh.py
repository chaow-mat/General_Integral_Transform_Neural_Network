...
################################################################
model = GIT_lpn(r_f, d_width, c_width, r_g)
...
# save worse case
    if cfg.state=='eval':
        ...
        savemat('predictions/GIT_lpn/GIT_lpn_hh_median_' + string + '_id' + str(idx_median) + '.mat',
        ...
        savemat('predictions/GIT_lpn/GIT_lpn_hh_max_' + string + '_id' + str(idx_max) + '.mat',
                {'input': input, 'output': output, 'output_true': output_true})
